...
- port 5000
Routes:
0. `/` : display “Hello HBNB!”
1. `/hbnb` : display “HBNB”
--- The default value of <text> is “is cool” ---
2. `/c/<text>` : display “C ”
3. `/python/(<text>)` : display “Python ” (replace underscore _ symbols with a space )
...
6. `/number_odd_or_even/<n>` : display a HTML page only if n is an integer
